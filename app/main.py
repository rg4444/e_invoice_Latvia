...
def save_config_route(
    ...
    dotnet_bridge_path: str = Form(""),
    dotnet_cert_pfx_path: str = Form(""),
    dotnet_cert_pfx_password: str = Form(""),
    java_bridge_dir: str = Form(""),
    java_bridge_lib_dir: str = Form(""),
    ...
    cfg.update({
        ...
        "DOTNET_BRIDGE_PATH": dotnet_bridge_path.strip(),
        "DOTNET_CERT_PFX_PATH": dotnet_cert_pfx_path.strip(),
        "DOTNET_CERT_PFX_PASSWORD": dotnet_cert_pfx_password,
        "JAVA_BRIDGE_DIR": java_bridge_dir.strip(),
        "JAVA_BRIDGE_LIB_DIR": java_bridge_lib_dir.strip(),
